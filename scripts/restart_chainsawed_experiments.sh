#!/usr/bin/env bash
# Quarantine striping checkpoints and resume stopped longrun jobs with patched parameters.
set -euo pipefail
...
CASE_LINES=(
  "experiment_longrun_fullwall_cons_paper_wang_ca120_r0p12_u1p5_|res_wang_ca120_r0p12|configs/generated_sliding_long_realpaper_longrun/paper_wang_ca120_r0p12_u1p5.json|7500 10000 12500 15000 17500 20000"
  ...
  "experiment_terrain_longrun_fullwall_cons_terrain_groove_amp0p04_ca120_r0p15_u1p5_|res_terrain_groove04_ca120|configs/generated_sliding_terrain_realpaper_longrun/terrain_groove_amp0p04_ca120_r0p15_u1p5.json|15000 17500"
  "experiment_terrain_longrun_fullwall_cons_terrain_groove_amp0p04_ca90_r0p15_u1p5_|res_terrain_groove04_ca90|configs/generated_sliding_terrain_realpaper_longrun/terrain_groove_amp0p04_ca90_r0p15_u1p5.json|15000 17500"
  ...
  "experiment_terrain_longrun_fullwall_cons_terrain_incline_15deg_ca90_r0p15_|res_terrain_incline15|configs/generated_sliding_terrain_realpaper_longrun/terrain_incline_15deg_ca90_r0p15.json|15000 17500"
)
...
for line in "${CASE_LINES[@]}"; do
  ...
  tmux new-session -d -s "$session" bash -lc \
    "export PYTHONPATH=$REPO/src JAX_PLATFORMS=$JAX_PLATFORMS XLA_PYTHON_CLIENT_MEM_FRACTION=$XLA_PYTHON_CLIENT_MEM_FRACTION XLA_PYTHON_CLIENT_PREALLOCATE=$XLA_PYTHON_CLIENT_PREALLOCATE; cd $REPO && $PY -u main.py --resume $exp_dir 2>&1 | tee $exp_dir/resume_mitigated.log"
