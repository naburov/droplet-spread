...
def create_gif_from_experiment(experiment_dir, output_filename='animation.gif', duration=200):
...
if __name__ == '__main__':
    ...
    create_gif_from_experiment(experiment_dir, output_filename, duration)
